...
echo Starting webcam monitor in a new window...
start "Fruit Monitor" cmd /k "cd /d %~dp0 && call .venv\Scripts\activate.bat && python -m src.monitor"

echo Starting Streamlit dashboard in this window...
